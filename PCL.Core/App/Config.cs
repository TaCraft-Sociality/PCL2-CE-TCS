...
public static partial class Config
{
    ...
    [ConfigGroup("Update")] partial class UpdateConfigGroup
    {
        ...
        /// 自动更新行为。
        /// </summary>
        [ConfigItem<LauncherAutoUpdateBehavior>("SystemSystemUpdate", LauncherAutoUpdateBehavior.Disable, ConfigSource.Local)] public partial LauncherAutoUpdateBehavior UpdateMode { get; set; }
    ...
    [ConfigGroup("Preference")] partial class PreferenceConfigGroup
    {
        ...
        /// 窗口标题文本。
        /// </summary>
        [ConfigItem<string>("UiLogoText", "PCL2 TCS", ConfigSource.Local)] public partial string WindowTitleCustomText { get; set; }
        ...
        partial class HideConfigGroup
        {
            ...
            [ConfigItem<bool>("UiHiddenSetupGameLink", true, ConfigSource.Local)] public partial bool SetupGameLink { get; set; } // 新增
