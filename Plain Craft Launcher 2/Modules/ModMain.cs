...
public static class ModMain
{
    ...
    // TCS 定制：社区与皮肤站（内置浏览器页面）
    public static PageTcsBrowser? frmTcsCommunity;
    public static PageTcsLeft? frmTcsCommunityLeft;
    public static PageTcsBrowser? frmTcsSkin;
    public static PageTcsLeft? frmTcsSkinLeft;
    public static PageTcsBrowser? frmTcsBili;
    public static PageTcsLeft? frmTcsBiliLeft;

    // TCS 定制：陶瓦联机页面（右侧复用内置浏览器，显示陶瓦自带的本地界面）
    public static PageTcsBrowser? frmTcsLink;
    public static PageTcsLinkLeft? frmTcsLinkLeft;
